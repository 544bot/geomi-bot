...
SpiderBot.on('message', msg => {
    ...
    if (!msg.author.bot) {
        if (msg.content == '거미 목록') {
            ...
            //         // fs.writeFileSync('baloney01.txt', '\ufeff'+baloney01.toString().replace(',',"\r\n"), {encoding: 'utf8'})
            //         console.log(baloney01.toString().replace('/,/g',"\r\n"))
            //         baloney02[baloney02.length] = remember_baloney[1]
            //         // fs.writeFileSync('baloney02.txt', '\ufeff'+baloney02.toString().replace(',',"\r\n"), {encoding: 'utf8'})
            //         console.log(baloney02.toString().replace('/,/g',"\r\n"))
            //     }
